...
export default function SortearClient({ eventTitle, confirmedParticipants }: SortearClientProps) {
  const router = useRouter()

  const initialPlayers: Player[] = confirmedParticipants.map((p) => ({
    userId:    p.user_id,
    name:      p.name,
    nickname:  p.nickname,
